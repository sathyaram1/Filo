...
3. i **modelli stretti** di produttori indipendenti. Puri classificatori, trascrittori o sintetizzatori vocali non sono il tipo di sistema di cui questo documento si preoccupa. Li ammetto, comprati dal produttore, purché il produttore non sia uno dei laboratori esclusi né sia controllato da uno di loro, e purché quello che compro non sia un servizio di quei laboratori e non ne contenga uno. Se il produttore rivende i loro servizi altrove, in prodotti che non compro, questo da solo non lo esclude. Conta dove vanno i soldi che pago io. Se contasse anche il cloud su cui gira un fornitore, dovrei escludere anche Anthropic, che ha un [grande accordo di calcolo con Google Cloud](https://www.anthropic.com/news/expanding-our-use-of-google-cloud-tpus-and-services).
...
ElevenLabs (sintesi vocale, modello Eleven v3), da settembre 2026. Lo compro direttamente da ElevenLabs e lo uso solo per la voce del video di presentazione di Filo. Dentro Filo la lettura ad alta voce resta a pesi aperti. ElevenLabs non addestra modelli linguistici generalisti e nessun laboratorio escluso è fra i suoi soci. Le riserve sono tre. Nella sua piattaforma di agenti [rivende modelli di OpenAI e di Google](https://elevenlabs.io/docs/agents-platform/customization/llm), che io non compro. I suoi modelli [girano su Google Cloud](https://www.prnewswire.com/news-releases/elevenlabs-partners-with-google-cloud-for-cloud-services-and-the-latest-nvidia-blackwell-gpus-302697853.html). Da giugno 2026 [inserisce nell'audio la filigrana SynthID](https://help.elevenlabs.io/hc/en-us/articles/48099714323857-Is-my-audio-being-watermarked-right-now) di Google DeepMind, e non risulta se Google venga pagata per questo. Da rivedere a dicembre 2026.
...
Chi risponde diversamente da me non deve forkare: **un solo interruttore disattiva tutti i modelli proprietari** — Anthropic inclusa, in modo che non vengano dati soldi a nessun produttore di modelli. Funziona anche con i crediti di Filo, con un click (per escludere Anthropic non serve una propria chiave, come serve invece per usare modelli che non supporto).
...
Puoi cambiare ogni default: è il senso dell'open source e non posso chiederti di adottare la mia visione del mondo. Ma ti chiedo una cosa sola: poniti le stesse domande, non è necessario arrivare alle mie conclusioni, ma passa dagli stessi dubbi. Se pesi diversamente le stesse questioni, va bene così.

---

Scritto da Sathya con Claude — il che, dato l'argomento, non è un dettaglio neutro.

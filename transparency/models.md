...
- **xAI**: il modello in produzione [si è auto-definito "MechaHitler"](https://techcrunch.com/2025/07/10/grok-4-seems-to-consult-elon-musk-to-answer-controversial-questions/) prima di essere corretto, e cerca le opinioni di Elon Musk prima di rispondere su temi controversi. La catena di controllo è documentabile: dal 2 febbraio 2026 SpaceX possiede il 100% di xAI, Musk controlla circa l'80% dei diritti di voto di SpaceX tramite azioni a voto multiplo, ed è contemporaneamente fondatore, CEO e presidente del board di xAI, CEO di Tesla (che ha investito in xAI) e proprietario di X. Musk inoltre non è neutrale nella politica americana ma ha forti legami con l'amministrazione attuale (problema analogo al caso di OpenAI).

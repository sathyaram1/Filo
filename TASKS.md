...
- [x] **R4 — Cost-check / utilizzo budget nella sandbox cloud** — _(dispositionato
  2026-06-27)_ — la regola di stop sul budget vive ora nel nuovo **`ROUTINES.md`**
  (§ budget dell'orchestratore: legge `costUSD` da ccusage, soglia ALTA, fallback al
  budget di contesto, rete di sicurezza sul 429). La verifica "ccusage gira in cloud?"
  resta accodata come feedback diagnostico (vedi sotto); non è più un item di TASKS.md.
  — Verifica che

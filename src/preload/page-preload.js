...
function loadScripts() {
  ...
  try { require(path.join(SHARED_DIR, 'overlayPlacement.js')); } catch (e) { console.error('[Filo CS] overlayPlacement', e); } // #502 — geometria degli overlay che crescono: PRIMA di popup.js e menu.js

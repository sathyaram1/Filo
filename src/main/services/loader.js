...
// #536 — guardiano del testo verso l'utente: controlli statici, frasi di blocco,
// prompt e verdetto del secondo modello. Logica pura, nessun I/O.
require(path.join(SHARED, 'textGuard.js'));

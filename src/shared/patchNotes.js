...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        'Gli avvisi che nascono da una mail o da una pagina non compaiono più senza un secondo controllo. Un modello diverso da quello che ha scritto l\'avviso si chiede se stia cercando di farti consegnare un codice, pagare qualcosa o aprire un collegamento che porta altrove; prima ancora, un controllo che gira sul tuo computer ferma codici usa e getta, chiavi, coordinate bancarie e collegamenti che non portano dove dicono. Quando un avviso viene fermato te lo dice in una riga, con cosa ha visto, e lo ritrovi in Preferenze fra gli avvisi fermati. Se il controllo non riesce — rete giù, modello che non risponde — l\'avviso aspetta e compare più tardi: non compare mai senza controllo. E i collegamenti dentro un avviso mostrano sempre dove portano davvero, prima che tu li apra.',

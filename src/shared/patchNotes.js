  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        ...
        'Le pagine di gestione riservate sono ora raccolte sotto un\'unica icona "Gestione" in alto a destra nella home, invece di essere sparse tra i menu App e Impostazioni.',
      ],
      fixes: [

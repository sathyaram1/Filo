  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        ...
        'Il timer e la sveglia suonano da qualunque scheda tu stia guardando, anche se la pagina Nuova scheda non è aperta, e anche in una finestra incognito. Prima il suono usciva solo dalla Nuova scheda. Mentre suona, in cima alla finestra c’è il pulsante che la ferma, e finché suona quel pulsante resta a portata: se mandi qualcosa a tutto schermo Filo ne esce da solo.',

...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        'Quando Filo scrive di aver messo una sveglia ma non l\'ha messa, ci riprova da solo. Se sbaglia di nuovo, sotto la risposta trovi scritto che la sveglia non c\'è e un tasto per fargliela mettere davvero: prima lo scoprivi la mattina in cui non suonava. Vale anche per appunti, impostazioni, pagine aperte e segnalazioni, e per quando Filo risponde con un pezzo del suo formato interno al posto della risposta. Lo stesso controllo vale ora anche nell\'Aiuto, il pannello che si apre sulle pagine: se scrive di aver mandato una segnalazione e non l\'ha mandata, o se la risposta arriva storta, ci riprova; e se non basta te lo dice, col tasto per farglielo fare davvero, invece di lasciarti credere che sia fatto o lasciarti la chat vuota.',

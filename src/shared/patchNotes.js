  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        ...
        'Le pagine delle impostazioni seguono quello che chiedi a Filo mentre sono aperte, fino in fondo. Anche i colori, i font e gli angoli dell\'interfaccia, e anche la pagina Sicurezza e privacy: prima mostravano ancora i valori di quando le avevi aperte, e al primo interruttore che toccavi quello che avevi chiesto a Filo tornava indietro senza dire niente.',

...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        'Il tetto di spesa mensile che imposti vale adesso per ogni chiamata ai modelli, comprese quelle che Filo fa da solo mentre navighi: il controllo sui siti pericolosi, il riconoscimento delle pagine bloccate nel tuo paese, la voce che legge ad alta voce, il titolo di una segnalazione. Prima quelle giravano senza tetto e non comparivano nella spesa.',

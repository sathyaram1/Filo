...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        'Dopo aver importato un backup, le schede già aperte (pagine salvate, cronologia, archivio, scaricamenti, mazzi, editor, preferenze) mostrano subito i dati ripristinati, senza chiuderle e riaprirle.',

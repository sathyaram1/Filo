  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        ...
        'Filo adesso c\'è anche per Linux: si scarica un file solo e si aggiorna da sé. La prima volta quel file va reso eseguibile (tasto destro, Proprietà, «Consenti l\'esecuzione»), e su Ubuntu 22.04 e successive serve una volta sola il pacchetto libfuse2: accanto al download trovi il foglietto con tutti i passi. Se un aggiornamento non riesce a installarsi, Filo te lo scrive fra le notifiche invece di lasciarti fermo a una versione vecchia.',
      ],
      fixes: [

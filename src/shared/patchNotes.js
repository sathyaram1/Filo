...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        '"Traduci la pagina" ora traduce davvero tutta la pagina: titolo, sommario, didascalie delle foto, riquadri "Leggi anche", voci di menu e testo dei link, non più i soli paragrafi. Funziona anche sui siti moderni dove prima non succedeva nulla, la traduzione compare mano a mano che è pronta e, se non c\'è niente da tradurre o è riuscita solo in parte, adesso te lo dice. Le illustrazioni, i grafici, i loghi e le formule restano intatti, colori compresi.',

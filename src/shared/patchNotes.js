...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        'Il tasto destro su un’immagine dice anche da dove viene, quando il file lo dichiara: generata o modificata con l’AI, oppure scattata con una fotocamera, e chi lo dichiara. Filo legge le credenziali firmate, l’etichetta IPTC/XMP e i parametri di generazione dentro i PNG, sul tuo computer e senza spendere crediti, e ti dice quando la firma non torna o il file è stato cambiato dopo. Se il file non dichiara niente, Filo tace: nessuna etichetta non vuol dire immagine autentica. Vale anche chiedendoglielo in chat o a voce.',

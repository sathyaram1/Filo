...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        'Quando Filo scrive di aver messo una sveglia ma non l\'ha messa, ci riprova da solo. Se sbaglia di nuovo, sotto la risposta trovi scritto che la sveglia non c\'è e un tasto per fargliela mettere davvero: prima lo scoprivi la mattina in cui non suonava. Vale anche per appunti, impostazioni, pagine aperte e segnalazioni, e per quando Filo risponde con un pezzo del suo formato interno al posto della risposta.',

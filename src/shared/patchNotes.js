  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        ...
        'A schermo intero Esc chiude prima quello che hai aperto sopra la pagina: la risposta di Filo, il menu del tasto destro, un\'immagine ingrandita. Prima li scavalcava e ti buttava fuori dallo schermo intero lasciandoli lì; adesso ne esci col tasto dopo.',
      ],
    },
    {

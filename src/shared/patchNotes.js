...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        'Filo adesso legge le pagine web: quando cerchi qualcosa e il riassunto dei risultati non basta, apre le pagine e ti risponde con il dato che c\u2019\u00e8 scritto dentro \u2014 un prezzo, un orario, un punteggio, una clausola \u2014 invece di rimandarti a leggere da te.',

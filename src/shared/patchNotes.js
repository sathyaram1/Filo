  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        ...
        'Nella lista dei siti da bloccare ora puoi scrivere anche un indirizzo numerico (per esempio il pannello del router di casa, 192.168.1.1): prima veniva accettato in apparenza ma non bloccava nulla.',
        'Sulla Bacheca, se un voto non viene registrato, ora te lo dice: prima il conteggio saliva e tornava indietro da solo senza una parola di spiegazione.',
      ],
    },
    {

  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        ...
        'Un link che imita l\'indirizzo di un sito noto te lo dice con una frase, appena apri il menu del tasto destro. Prima usciva un codice interno, e compariva solo insieme alla spiegazione del link; se la spiegazione non arrivava, l\'avviso non lo vedevi affatto. L\'avviso su un indirizzo che porta con s\u00e9 un codice d\'accesso non scatta pi\u00f9 sui link di tutti i giorni, come un video che parte da un certo minuto.',

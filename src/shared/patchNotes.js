...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        'La suoneria del timer e delle sveglie ha il suo volume, in Preferenze accanto alla scelta del motivo, e lo stesso vale per il suono delle notifiche. Puoi girare le manopole o chiederlo a Filo: "abbassa il volume della suoneria", "metti la suoneria delicata", "azzera il volume delle notifiche", "tieni le notifiche dieci secondi". A zero resta muta. Se gli chiedi un motivo per le notifiche, Filo accende anche il suono.',
        'Ogni impostazione di Preferenze si può chiedere a Filo a parole. Se la pagina è aperta mentre glielo chiedi, la manopola si muove da sola.',
      ...
      fixes: [
        ...
        'Le pagine delle impostazioni seguono quello che chiedi a Filo mentre sono aperte, fino in fondo. Anche i colori, i font e gli angoli dell\'interfaccia, anche la pagina Sicurezza e privacy, e anche la manopola o l\'interruttore che hai appena toccato: prima mostravano ancora i valori di quando le avevi aperte, e al primo interruttore che toccavi quello che avevi chiesto a Filo tornava indietro senza dire niente. E il riquadro che sceglie la tonalità esatta di un colore adesso cambia solo il suo: gli altri colori che hai cambiato mentre era aperto restano dove li hai messi.',
        ...
        'Il timer e la sveglia suonano da qualunque scheda tu stia guardando, anche se la pagina Nuova scheda non è aperta, e anche in una finestra incognito. Prima il suono usciva solo dalla Nuova scheda. Mentre suona, in cima alla finestra c’è il pulsante che la ferma, e finché suona quel pulsante resta a portata: se mandi qualcosa a tutto schermo Filo ne esce da solo. E se non hai nessuna finestra aperta dove quella scadenza si possa sentire, Filo ne apre una invece di restare muto.',

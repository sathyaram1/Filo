  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        ...
        'Quando Filo cambia l’aspetto di una pagina, quello che ci mette dentro non va più a prendere immagini o altro in rete. Era una strada per cui quello che ti aveva appena letto poteva uscire dal computer senza che nessuno ti chiedesse niente. E la ricerca che l’assistente dentro una pagina fa sul testo che gli indichi ora ti mostra l’indirizzo intero prima che parta, dove prima ne vedevi solo l’inizio.',

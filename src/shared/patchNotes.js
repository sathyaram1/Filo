...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        'La suoneria del timer e delle sveglie ha il suo volume, in Preferenze accanto alla scelta del motivo, e lo stesso vale per il suono delle notifiche. Puoi girare le manopole o chiederlo a Filo: "abbassa il volume della suoneria", "metti la suoneria delicata", "azzera il volume delle notifiche", "tieni le notifiche dieci secondi". A zero resta muta. Se chiedi un suono per le notifiche, Filo lo accende: prima potevi sceglierne uno e non sentirlo mai.',
        'Ogni impostazione di Preferenze si può chiedere a Filo a parole, e la pagina lasciata aperta lo segue: quello che chiedi si vede subito sulle manopole e non torna più indietro quando ne tocchi un\'altra.',

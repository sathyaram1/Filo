  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        ...
        'Filo tiene conto di quello che ha letto in quella conversazione. Dopo una pagina web, una ricerca o un documento scritto da qualcun altro, prima di fare qualcosa che dura ti chiede il permesso, e ti dice perché lo chiede. Prima leggere una pagina non cambiava niente, e chi l\'aveva scritta poteva farsi dare gli stessi poteri che avevi dato tu. Al livello più prudente contano anche i titoli delle schede che tieni aperte e le immagini che gli passi, e quando a quel livello una cosa non si può fare Filo ti dice come farla lo stesso.',
        'Meno conferme dove non servivano. Filo fa e basta le cose che si disfano o che si rimediano: mettere una sveglia, cambiare il tema, stringere una protezione, fissare una cosa che gli hai detto di ricordare. Il permesso te lo chiede dove conta: quello che parte a tuo nome, i comandi che modificano, i link che portano fuori tuoi dati.',

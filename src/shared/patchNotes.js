...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        'La suoneria del timer e delle sveglie ha il suo volume, in Preferenze accanto alla scelta del motivo, e lo stesso vale per il suono delle notifiche. Puoi anche chiederlo a Filo ("abbassa il volume della suoneria"). A zero resta muta.',

...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        'Il tasto destro su un’immagine dice anche da dove viene, quando il file lo dichiara. Generata o modificata con l’AI, oppure scattata con una fotocamera, e chi lo dice. Filo lo legge dentro il file, sul tuo computer, senza spendere crediti, e ti avverte se la firma non torna o se qualcuno ha cambiato il file dopo. Quando il file non dichiara niente, Filo non dice niente: nessuna etichetta non vuol dire che l’immagine sia vera, perché uno screenshot le cancella e molti generatori non le mettono. Vale anche se lo chiedi in chat o a voce.',

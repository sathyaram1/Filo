  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        ...
        'Se metti una tua chiave OpenRouter, quello che spendi con lei non riempie più il tetto di spesa mensile e non ti consuma i crediti, che restano la riserva per quando quella chiave viene rifiutata. Prima a cinque euro Filo smetteva di rispondere, chat compresa, per soldi che aveva pagato tu. Nelle opzioni quella spesa la vedi a parte.',
        ...
        'Il controllo sui siti pericolosi lascia in pace la tua rete di casa: il router, il NAS, la stampante, un server di prova sul tuo computer. Prima su ognuno di quegli indirizzi partiva una verifica che non poteva dare nessun risultato, e il loro indirizzo usciva da Filo.',
        'Nelle finestre in incognito Filo non manda più fuori l\'indirizzo delle pagine che apri. L\'avviso sui siti pericolosi continua a lavorare sul tuo computer, ma senza chiedere niente a nessuno.',
        'Il controllo sui siti pericolosi non ripete più la stessa domanda a ogni sottodominio, e non la fa due volte per la stessa pagina. Un sito che cambiava indirizzo a ogni pagina ne faceva partire una raffica, pagata dal tetto di spesa che adesso la comprende.',
        'Quando il tetto di spesa del mese è finito, Filo controlla lo stesso se un sito è già noto come truffa: quella verifica non costa niente e non si spegne più insieme alle altre.',
        'Una pagina che ti sposta da sola su indirizzi sempre nuovi non fa più partire controlli a raffica sul tuo tetto di spesa: tutti i salti di una stessa sequenza hanno un conto solo, e appena navighi tu il conto riparte intero.',
        'Anche il riconoscimento delle pagine bloccate nel tuo paese lascia in pace la tua rete di casa, e non parte per niente nelle finestre in incognito. Per capire perché una pagina non si vede, Filo ne manda al modello il titolo e le prime righe: sul pannello del router, sul disco di rete o su un server di prova sul tuo computer quel testo usciva da casa tua, e in incognito usciva da una finestra che promette di non lasciare traccia.',

  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        ...
        'Filo adesso c\'è anche per Linux. Si scarica un file solo, si apre con un doppio clic e si aggiorna da sé; se un aggiornamento non riesce a installarsi, Filo te lo scrive fra le notifiche invece di lasciarti fermo a una versione vecchia.',
      ],
      fixes: [

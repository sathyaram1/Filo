  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        ...
        'Nessun sito ti fa più comparire una domanda solo perché ha guardato cosa può fare. E se ne fa una e tu tre volte di fila dici di no o la chiudi, su quella pagina smette di chiedere e te lo scrive, con «Chiedimelo di nuovo» accanto: prima, sullo schermo, poteva tenerla lì finché non te ne andavi.',
        'Le domande dei permessi arrivano anche dalle finestre di accesso, quelle che si aprono a parte con «Continua con Google». Prima lì non compariva niente, la pagina restava appesa e finiva negata da sola.',

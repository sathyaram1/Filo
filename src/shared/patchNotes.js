  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        ...
        'Quando chiedi a Filo di segnarti un appuntamento, il bottone «Aggiungi al calendario» ora funziona davvero: apre l’evento nel calendario del tuo computer, con giorno, ora, durata e note già scritti. Prima era spento e la proposta non portava da nessuna parte.',
      ],
      fixes: [
        ...
        'Nel diario del lavoro le impostazioni si leggono in italiano («Modalità terminale → attiva»), non col nome interno e il valore grezzo. E quando confermi un’impostazione dopo che Filo ha già risposto, la riga in cima al blocco lo dice, invece di restare su «Come ha lavorato».',
        'Se chiedi a Filo di riordinare le schede o di cancellare qualcosa dall\'archivio, il bottone per farlo compare di nuovo: al suo posto restava un «Azione non riuscita», e quelle due cose dalla chat non si ottenevano più. Quando le porti a termine, il diario del lavoro scrive cosa è successo, come per l\'evento aggiunto al calendario e per il comando che confermi nel popup. E il riordino chiesto dal suggerimento della home ti dice quante schede ha archiviato.',
        'Quando Filo ti chiede di confermare un\'impostazione che poi non sa applicare, adesso te lo dice prima, nel popup, e dopo ti spiega perché non è cambiato niente. Prima attraversavi tre schermate e in nessuna c\'era scritto cosa fosse andato storto.',
        'Anche le altre cose che confermi nel popup lasciano la loro riga nel diario: se dici a Filo di dimenticare tutto quello che sa di te, adesso c’è scritto che l’ha fatto. E il bottone, una volta confermato, dice cos’è successo invece di continuare a dire che Filo «vuole» farlo.',
        'Una conversazione riaperta dalla Cronologia racconta quello che è successo davvero. Prima dava per fatto tutto quello che Filo aveva solo nominato: diceva di aver cancellato la memoria per una conferma che non avevi dato, chiamava «proposta» una cena che era nel calendario da giorni, e dava per cambiata un\'impostazione rimasta com\'era.',
        ...
        'Se chiedi due appuntamenti in una volta sola, il diario del lavoro li tiene distinti: aggiungendone uno al calendario, l\'altro non spariva più dal racconto sostituito da una copia del primo.',

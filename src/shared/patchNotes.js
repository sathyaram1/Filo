...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        'I siti personali pubblicati su GitHub Pages, GitLab Pages, Vercel, Netlify e piattaforme simili non fanno più scattare «GitHub? Controlla l\'indirizzo». Filo guarda l\'indirizzo del sito, non quello della piattaforma che lo ospita. Una pagina che lì sopra si spaccia per PayPal o per la tua banca viene ancora segnalata.',

...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        'A schermo intero ogni riquadro che hai aperto sopra la pagina costa il suo Esc, quanti che ne siano, e lo schermo intero resta finché non li hai chiusi tutti. Dal quarto in su il tasto ti buttava fuori lasciando aperto quello in cima.',

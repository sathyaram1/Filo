...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        'Filo adesso legge le pagine web. Quando cerchi qualcosa e il riassunto dei risultati non basta, apre le pagine più promettenti e ti risponde con il dato che c’è scritto dentro: un prezzo, un orario, un punteggio, una clausola, la data e la firma di un articolo, le risposte sotto una domanda. Legge anche quello che il sito tiene chiuso finché non lo apri: la risposta di una domanda frequente, la scheda del listino che non è in primo piano, il seguito di «leggi tutto». Prima poteva solo rimandarti a leggere da te. Se il link porta a un PDF legge anche quello. Lo fa anche l’assistente laterale, quando cerca sul web per aiutarti su un sito.',

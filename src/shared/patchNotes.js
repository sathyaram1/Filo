...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        'Quando Filo ha letto qualcosa scritto da altri — una pagina, i risultati di una ricerca, una mail, un documento, l\'uscita di un comando — quello che ti scrive dopo passa da un secondo controllo prima di comparire. Vale per la risposta in chat, per il saluto della home, per le spiegazioni del tasto destro e per gli avvisi. Prima un controllo che gira sul tuo computer ferma codici usa e getta, chiavi, coordinate bancarie e collegamenti che non portano dove dicono. Poi un modello diverso da quello che ha scritto il testo si chiede se stia cercando di farti consegnare un codice, pagare qualcosa o aprire in fretta un link. Quando ferma qualcosa te lo scrive in una riga, dicendo cosa ha visto, e da lì arrivi con un clic all\'elenco in Preferenze. Se il controllo non riesce, quel testo non compare: un avviso aspetta in coda e arriva più tardi, una risposta te la puoi richiedere. E i collegamenti dentro un avviso mostrano sempre dove portano davvero, prima che tu li apra.',
      ...
      fixes: [
        ...
        'I file con accenti o trattini lunghi nel nome si aprono di nuovo. Prima Filo li trovava sul disco, ne leggeva il nome storpiato e subito dopo diceva che quel file non esiste. Ora, se il nome che gli dai è quasi giusto, apre quello giusto e ti dice quale ha aperto; se i file quasi uguali sono più d\'uno te li elenca invece di tirare a indovinare. Vale anche per i comandi che scrivi tu nel terminale: un nome con l\'accento arriva alla lettera.',
        'Quando Filo entra in una cartella col terminale, adesso ci resta. Prima, al messaggio dopo, era già tornato nella tua cartella personale: il file che aveva appena trovato spariva, e un comando che ti aveva chiesto di confermare veniva eseguito in una cartella diversa da quella che ti aveva mostrato.',
        'I file di testo salvati come «Unicode» — quelli che escono dal Blocco note e dal terminale di Windows — si leggono per quello che c\'è scritto, anche quando il file non dice in testa com\'è scritto. Prima Filo diceva di averli letti e aveva in mano caratteri vuoti, quindi rispondeva sul nulla.',
        'Anche i file salvati come «ANSI», il modo in cui il Blocco note e Excel salvano da sempre, arrivano a Filo per intero. Prima il trattino lungo, le virgolette curve, l\'apostrofo e il simbolo dell\'euro sparivano senza lasciare traccia, e Filo rispondeva su un testo bucato.',

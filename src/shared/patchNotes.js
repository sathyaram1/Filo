  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        ...
        'In Preferenze c’è la memoria di Filo: quello che si è appuntato su di te mentre parlavate. Puoi rileggerlo e togliere le righe che non vuoi, una per volta, senza cancellare tutto il resto.',

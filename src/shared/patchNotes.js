  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        ...
        '«Traduci la pagina» entra anche nei riquadri incorporati: post incorporati, blocchi commenti, moduli di iscrizione. Prima restavano in inglese in mezzo a una pagina italiana, e cliccare Traduci proprio lì dentro non li toccava. Dove il sito non lascia leggere il testo del riquadro, l\'avviso lo dice invece di dichiarare finito.',

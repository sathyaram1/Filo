...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        'Filo adesso legge le pagine web. Quando cerchi qualcosa e il riassunto dei risultati non basta, apre le pagine più promettenti e ti risponde con il dato che c’è scritto dentro: un prezzo, un orario, un punteggio, una clausola, la data e la firma di un articolo, le risposte sotto una domanda. Prima poteva solo rimandarti a leggere da te. Lo fa anche l’assistente laterale, quando cerca sul web per aiutarti su un sito.',

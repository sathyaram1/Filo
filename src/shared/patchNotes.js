...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        'Se la bacheca non riesce a rileggere i miglioramenti te lo dice, con \'Riprova\', invece di lasciare la rotella che gira e i miglioramenti di prima ancora a schermo come se fossero appena arrivati.',

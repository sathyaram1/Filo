...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        'Gli avvisi che nascono da una mail o da una pagina non compaiono più senza un secondo controllo. Prima un controllo che gira sul tuo computer ferma codici usa e getta, chiavi, coordinate bancarie e collegamenti che non portano dove dicono. Poi un modello diverso da quello che ha scritto l\'avviso si chiede se il testo stia cercando di farti consegnare un codice, pagare qualcosa o aprire in fretta un link. Quando ne ferma uno te lo scrive in una riga, dicendo cosa ha visto, e lo ritrovi in Preferenze fra gli avvisi fermati. Se il controllo non riesce, perché la rete è giù o il modello non risponde, l\'avviso aspetta e compare più tardi. Senza controllo non compare mai. E i collegamenti dentro un avviso mostrano sempre dove portano davvero, prima che tu li apra.',

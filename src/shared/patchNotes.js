...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      features: [
        'Quando Filo legge qualcosa scritto da altri, per esempio una pagina web, un documento, dei risultati di ricerca o i titoli delle schede che hai aperto, da lì in poi può fare solo le cose che gli avevi chiesto. Se gli serve fare altro te lo chiede, dicendoti quale azione e perché, e il permesso vale solo per quella richiesta: il messaggio dopo non riparte con tutto in mano, e un permesso dato all’assistente di un sito non lo segue su un altro sito. Così una pagina che prova a dargli ordini non ottiene niente. In filo://security/ vedi cosa gli era permesso in ogni richiesta recente.',

...
(function (global) {
  ...
  const NOTES = [
    // ↓ Nuove versioni in cima.
    {
      ...
      fixes: [
        'I siti personali pubblicati su GitHub Pages, GitLab Pages e piattaforme simili non fanno più scattare «GitHub? Controlla l\'indirizzo». Filo guarda l\'indirizzo del sito, non quello della piattaforma che lo ospita. Vale anche al contrario: una pagina che si spaccia per PayPal o per la tua banca su Vercel, Netlify, Amazon, SharePoint, WordPress o Medium prima passava per fidata insieme alla piattaforma, adesso viene segnalata. Lo stesso per le pagine che chiunque pubblica su Google Sites, Moduli Google, Microsoft Forms, Notion, Canva e archive.org: se ti chiedono una password, Filo le controlla invece di fidarsi del nome di Google o Microsoft.',

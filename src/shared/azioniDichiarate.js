...
(function (global) {
  ...
  // punteggiatura.
  const BUSTE = /<\s*\/?\s*(?:tool_call|tool▁call|tool_use|function_call|function_calls|invoke|antml:invoke)\b|<\s*function\s*=\s*[A-Za-z_]|<[|｜][^|｜>]{0,40}tool[^|｜>]{0,40}[|｜]>|\[TOOL_CALLS\]|<\|[a-z_]{2,20}\|>|\bto\s*=\s*(?:functions?|tools?)\s*\.\s*[A-Za-z_]/i;

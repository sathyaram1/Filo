...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    },
    {
      ...
      doesNot: 'Non controlla le risposte a domande che non hanno letto niente di altri: su «che ore sono» non si scomoda. Se il controllo non riesce, perché la rete è giù o il fornitore non risponde, l\'avviso non ti viene mostrato lo stesso. Aspetta in coda, visibile, e compare appena il controllo riesce.',
    },
    {

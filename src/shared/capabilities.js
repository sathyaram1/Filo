...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    },
    {
      ...
      desc: 'Fotocamera, microfono, posizione, notifiche, lettura degli appunti e cattura dello schermo: nessun sito li prende da solo. Quando un sito ne chiede uno, sotto la fila delle schede compare una pastiglia col suo nome e con quello che vuole, e scegli tu fra Consenti e Nega. Se non rispondi, il sito non ottiene niente. La domanda resta legata alla scheda che l\'ha fatta: quelle delle altre schede aspettano che tu ci passi sopra. Filo ricorda la risposta per quel sito; puoi cambiarla o toglierla quando vuoi, e il sito a cui la togli torna a chiedere. Lo schermo fa eccezione e non si ricorda mai: te lo richiede ogni volta, e ogni volta scegli tu se mostrare tutto lo schermo o una finestra sola. Se il sito vuole anche l\'audio del computer è una scelta a parte dentro lo stesso riquadro, e parte spenta. E finché un sito può vedere il tuo schermo resta scritto sotto le schede, col suo nome, con «Interrompi» accanto e con l\'audio nominato se glielo hai dato. Nelle finestre in incognito le risposte valgono solo finché la finestra resta aperta, e le rivedi e le togli sia dal tasto destro sulla scheda sia in Impostazioni → Sicurezza.',

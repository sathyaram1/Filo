...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    },
    {
      ...
      invoke: 'Chiedi all’assistente di prendere nota di qualcosa; la conferma «Salvato» che compare in chat apre l’Editor con un click. Ci arrivi anche dall’icona con il foglio degli appunti (menu App o menu del tasto destro): il file giusto lo scegli nel selettore documenti in alto a sinistra.',

...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    },
    {
      ...
      doesNot: 'Non concede nulla in silenzio, nemmeno ai siti che visiti spesso, e non chiede niente per le cose innocue: mettere un video a tutto schermo, incollare quello che ti ha copiato un bottone "copia", tenere acceso lo schermo mentre guardi un film. Non fa comparire una domanda per un sito che si è limitato a guardare cosa può fare, e se ne chiudi tre senza rispondere quella pagina smette di chiedere finché non la ricarichi. La posizione te la chiede ma non la sa calcolare: se consenti, Filo te lo dice invece di lasciarti davanti a una mappa vuota.',
    },
    {

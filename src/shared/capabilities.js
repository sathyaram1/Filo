...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    },
    {
      ...
      doesNot: 'Non concede nulla in silenzio, nemmeno ai siti che visiti spesso, e non chiede niente per le cose innocue: mettere un video a tutto schermo, incollare quello che ti ha copiato un bottone "copia", tenere acceso lo schermo mentre guardi un film.',
    },
    {

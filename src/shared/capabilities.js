...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    },
    {
      ...
      invoke: 'Menu del tasto destro → "Editor", oppure filo://editor/editor.html. Il selettore documenti è in alto a sinistra; col tasto destro sul titolo apri il menu (rigenera titolo, rigenera riassunto, rinomina, duplica, elimina). Dopo una modifica automatica di Filo, l\'avviso "Annulla" in basso a destra la annulla.',

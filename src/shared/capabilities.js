...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    },
    {
      ...
      desc: 'Fotocamera, microfono, posizione, notifiche, lettura degli appunti e cattura dello schermo: nessun sito li prende da solo. Quando un sito ne chiede uno, sotto la fila delle schede compare una pastiglia col suo nome e con quello che vuole, scritto in italiano, e scegli tu fra Consenti e Nega. Se non rispondi, il sito non ottiene niente. La domanda resta legata alla scheda che l\'ha fatta: quelle delle altre schede aspettano che tu ci passi sopra. Filo ricorda la risposta per quel sito; puoi cambiarla o toglierla quando vuoi, e il sito a cui la togli torna a chiedere. Lo schermo fa eccezione e non si ricorda mai: te lo richiede ogni volta, e ogni volta scegli tu se mostrare tutto lo schermo o una finestra sola. Se il sito vuole anche l\'audio del computer è una scelta a parte dentro lo stesso riquadro, e parte spenta. Finché un sito può usare la fotocamera, il microfono o vedere il tuo schermo, resta scritto sotto le schede cosa può fare, col suo nome, con «Interrompi» accanto e con l\'audio nominato se glielo hai dato; sulla scheda stessa compare un puntino che lo dice anche mentre ne guardi un\'altra, e cliccandolo ci torni. E togliergli la risposta gli toglie anche quello che ha già in mano, senza portarti via la pagina su cui stavi scrivendo. Nelle finestre in incognito le risposte valgono solo finché la finestra resta aperta, e le rivedi e le togli sia dal tasto destro sulla scheda sia in Impostazioni → Sicurezza, dove trovi elencate anche quelle delle finestre normali, ciascuna con scritto a quale delle due appartiene.',
      ...
      doesNot: 'Non concede nulla in silenzio, nemmeno ai siti che visiti spesso, e non chiede niente per le cose innocue: mettere un video a tutto schermo, incollare quello che ti ha copiato un bottone "copia", tenere acceso lo schermo mentre guardi un film. Non fa comparire una domanda per un sito che si è limitato a guardare cosa può fare. Se tre volte di fila dici di no a QUELLA cosa, o chiudi la domanda senza rispondere, Filo smette di chiedertela su quella pagina, te lo scrive sotto le schede e accanto mette «Chiedimelo di nuovo»: le altre cose continua a chiedertele. La posizione te la chiede ma non la sa calcolare: se consenti, Filo te lo dice invece di lasciarti davanti a una mappa vuota.',
    },
    {

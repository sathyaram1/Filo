...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    // ─────────────────────── Lettura e traduzione ───────────────────────────
    {
      ...
      doesNot: 'Non traduce il testo dentro le immagini, i video, i riquadri di codice, le illustrazioni (grafici, loghi, icone disegnate nella pagina) e le formule, che restano intatte con i loro colori; non traduce le pagine dove non trova testo (in quel caso te lo dice). Se un sito tiene chiusi certi suoi componenti, quel testo non è leggibile da nessuno script e resta nella lingua originale. Se uno di quei riquadri è nella pagina e ci puoi arrivare — anche scorrendo, anche dentro un pannello che scorre per conto suo — l’avviso dice che la pagina è tradotta solo in parte; i riquadri che il sito tiene fuori dalla vista, come gli spazi pubblicitari e i banner già chiusi, non fanno comparire nessun avviso.',
    },

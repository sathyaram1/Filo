...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    // ─────────────────────── Lettura e traduzione ───────────────────────────
    {
      ...
      desc: 'Traduce tutto il testo visibile della pagina — titolo, sommario, didascalie, riquadri laterali, voci di menu e testo dei link, non solo i paragrafi — mantenendo impaginazione, link, immagini e illustrazioni; mentre lavora mostra a che punto è arrivata, e puoi tornare all’originale quando vuoi. Se si interrompe a metà (rete che salta, credito finito) te lo dice, con il motivo e il punto in cui si è fermata, e puoi riprenderla: completa solo i pezzi mancanti senza rifare quelli già tradotti.',
      ...
      doesNot: 'Non traduce il testo dentro le immagini, i video, i riquadri di codice, le illustrazioni (grafici, loghi, icone disegnate nella pagina) e le formule, che restano intatte con i loro colori; non traduce le pagine dove non trova testo (in quel caso te lo dice).',
    },
    ...
    },
    {
      ...
      invoke: 'Automatico: parte cliccando un link a un file. L’indicatore nella barra in alto apre l’elenco degli scaricamenti, dove puoi metterli in pausa, riprenderli, annullarli, aprirli o mostrarli nella cartella.',

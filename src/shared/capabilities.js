...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    // ─────────────────────── Lettura e traduzione ───────────────────────────
    {
      ...
      doesNot: 'Non traduce il testo dentro le immagini, i video, i riquadri di codice, le illustrazioni (grafici, loghi, icone disegnate nella pagina) e le formule, che restano intatte con i loro colori; non traduce le pagine dove non trova testo (in quel caso te lo dice). Se un sito tiene chiusi certi suoi componenti, quel testo non è leggibile da nessuno script e resta nella lingua originale: quando uno di quei riquadri è sotto i tuoi occhi l’avviso dice che la pagina è tradotta solo in parte, mentre quelli nascosti (spazi pubblicitari, banner già chiusi) non fanno uscire nessun avviso.',
    },

...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    // ─────────────────────── Lettura e traduzione ───────────────────────────
    {
      ...
      doesNot: 'Non traduce il testo dentro le immagini, i video, i riquadri di codice, le illustrazioni (grafici, loghi, icone disegnate nella pagina) e le formule, che restano intatte con i loro colori; non tocca quello che scrivi tu nei campi né i valori che il sito rimanda indietro quando invii un modulo (per questo la scritta su un bottone di invio che porta con sé un valore resta com\'è); non traduce quello che al momento è ripiegato o nascosto — lo offre quando lo apri; non traduce le pagine dove non trova testo (in quel caso te lo dice). Se un sito tiene chiusi certi suoi componenti, quel testo non è leggibile da nessuno script e resta nella lingua originale: in quel caso l’avviso dice che la pagina è tradotta solo in parte.',
    },

...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    },
    {
      ...
      desc: 'Chiedi a Filo di farti da timer ("timer di 10 minuti per la pasta"): il conto alla rovescia compare in alto nella nuova scheda e, allo scadere, suona un avviso, più una notifica di sistema. La suoneria si sente da qualunque scheda tu stia guardando, e in cima alla finestra compare un pulsante per fermarla. Puoi mettere in pausa un timer e riprenderlo quando vuoi, e puoi chiedere a Filo di annullarlo o di cambiargli la durata invece di rifarlo da capo.',

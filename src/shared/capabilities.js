...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    },
    {
      ...
      doesNot: 'Legge e basta: non apre schede, non compila moduli e non clicca niente al posto tuo. Di una pagina lunghissima legge la prima parte e ti avverte dove si è fermato. Non va a bussare da solo agli indirizzi della tua rete privata (il router, un server di casa o dell’ufficio); se però quella pagina è già aperta in una tua scheda, la legge da lì. Non legge i siti segnalati come pericolosi. Il testo di una pagina lo scrive chi possiede quel sito: Filo lo tratta come informazione da riportare, mai come istruzioni da eseguire.',
    },
    {

...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    },
    {
      ...
      invoke: 'Si costruisce da sola mentre usi l’assistente; puoi anche fissare tu una regola a parole («ricordati che…», «d’ora in poi…»): Filo la salva fra le sue lezioni e vale da subito in tutte le conversazioni. Quello che si è appuntato lo leggi in Preferenze → Memoria di Filo, e lì togli le righe che non vuoi, una per volta. Per fargli dimenticare tutto in un colpo chiediglielo a parole (ti chiederà di digitare "conferma").',

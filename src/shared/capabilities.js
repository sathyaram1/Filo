...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    },
    {
      ...
      invoke: 'Menu App → "Mazzi", oppure filo://decks/decks.html. Tasto destro su carte e mazzi per le azioni; click sul nome del mazzo per gestirlo; la barra in basso a sinistra del banco di lavoro è la chat/ricerca; click su una carta per sfogliarla nel carosello; le statistiche sono nel pannello destro a riposo.',
      doesNot: 'Non gioca partite.',
    },

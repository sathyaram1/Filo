...
(function (global) {
  ...
  const CAPABILITIES = [
    ...
    },
    {
      ...
      doesNot: 'Un file preso da un link finisce direttamente nella cartella Download di sistema, senza chiederti dove ogni volta (le immagini e i filmati salvati dal clic destro invece te lo chiedono, e quelli si possono annullare ma non mettere in pausa). L’elenco degli scaricamenti e i suoi comandi restano dentro Filo: i siti che visiti non possono leggerlo né comandarlo. In Sicurezza puoi spegnere la domanda sui programmi, o toglierla per i siti di cui ti fidi. Filo non controlla se un programma è davvero pericoloso. Ti dice che è un programma e da dove arriva, poi la scelta è tua. Le finestre in incognito non ci finiscono.',
    },
    {

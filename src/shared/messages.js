...
(function (global) {
  ...
  const MSG = {
    ...
    // #517 — il presidio delle azioni raccontate, per il pannello Aiuto. Il
    // pannello manda il TESTO che il modello ha scritto e cosa ha emesso; il
    // main lo confronta con le sveglie e gli appunti che esistono davvero e
    // risponde con le righe da mostrare. Lo stato dell'utente non esce dal
    // main: qui viaggiano solo il testo del modello e gli avvisi.
    // { testo, tipiEmessi, tipiPrecedenti, domandaUtente }
    // Risposta: { ok, fantasmi: [{ id, avviso, frase }] }
    FILO_AZIONI_RACCONTATE: 'filo_azioni_raccontate',

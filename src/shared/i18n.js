...
(function (global) {
  ...
  const STRINGS = {
    ...
    options_model_registry_desc:
      'Ogni modello ha un nickname (come lo chiami tu dentro Filo), un provider e il nome completo con cui chiamarlo via API. Le azioni qui sotto fanno riferimento al nickname. Per avere un fallback su un altro provider crea un secondo modello e aggiungilo come fallback nell\'azione.',
    options_models_desc: 'Per ogni azione scegli il modello principale e, se vuoi, uno o più modelli di fallback (usati in ordine se il principale fallisce). Usa "+ fallback" per aggiungere altri slot.',
    options_model_nickname: 'nickname',
    options_model_label: 'etichetta',
    options_model_provider: 'provider',
    options_model_full_id: 'nome completo (id API)',
    ...
    options_model_no_full_id: 'Inserisci il nome completo del modello',
    options_model_nickname_required: 'Il nickname è obbligatorio',
    options_model_nickname_duplicate: 'Nickname duplicato: %s',
    options_model_primary_ph: 'modello principale',
    options_model_fallback_ph: 'fallback',
    options_model_add_fallback: '+ fallback',
    options_model_remove_fallback: 'Rimuovi fallback',

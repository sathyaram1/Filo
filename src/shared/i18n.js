...
(function (global) {
  ...
  const STRINGS = {
    ...
    options_action_explain_link: 'Spiega link (anteprima della destinazione)',
    options_action_edit_text: 'Modifica testo con AI (riscrittura)',
    ...
    options_action_filo_lesson: 'Memoria di Filo — creazione delle lezioni',
    options_action_filo_compact: 'Memoria di Filo — compattazione dei ricordi',
    options_action_decks_chat: 'Mazzi — chat e ricerca carte',
    options_action_decks_opinion: 'Mazzi — parere di Filo sulle carte',
    options_action_decks_autotag: 'Mazzi — tag automatici',

...
(function (global) {
  ...
  const CLASSI = {
    ...
    // `privato`: la lettura porta dentro roba dell'utente, che non deve USCIRE
    // dentro qualcosa che il modello compone dopo (#533, ottavo giro). Una
    // pagina web no: è già pubblica, rimandarla fuori non è una fuga.

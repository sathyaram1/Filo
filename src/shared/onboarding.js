...
(function (global) {
  ...
  const ITEMS = [
    ...
    },
    {
      ...
      applica: 'Appena lo sai, emetti IMPOSTA_PREFERENZA con chiave "stile_agente" e il valore che descrive quello stile, e da lì in poi scrivi già così. Il valore deve essere solo la descrizione dello stile, breve: tono, lunghezza, del tu o del lei. È il sistema a mostrargliela e a chiedergli l’OK, quindi non chiedere conferma a parole e non dire di averlo già impostato.',
    },
    {
      id: 'estetica',
      kind: 'dire',

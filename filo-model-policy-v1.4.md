...
**Cosa succede quando lo accendi.** Quasi tutte le funzioni di Filo nascono con un modello proprietario: se l'interruttore si limitasse a spegnerlo, spegnerebbe mezza app. Quindi ogni funzione **passa automaticamente all'equivalente a pesi aperti**, e la pagina delle opzioni ti dice, appena lo accendi, quante cambiano e su quali modelli finiscono — spegnerlo rimette tutto com'era. Le funzioni che un equivalente non ce l'hanno — oggi la lettura ad alta voce, la dettatura, l'indicizzazione dell'archivio e le funzioni che devono guardare un'immagine, mestieri che nessun modello a pesi aperti raggiungibile da Filo sa fare — **si fermano e te lo dicono**, nominando la funzione. Il criterio è quello: il sostituto deve saper fare *quel* mestiere, non solo avere i pesi aperti. Mettere la dettatura su un modello che legge solo testo non sarebbe una sostituzione, sarebbe consegnarti una funzione rotta senza dirtelo.

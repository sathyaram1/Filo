...
capisce da dove sta: dopo una parola come `/utente/` o `/in/`, e in testa
all'indirizzo sui siti dove il primo pezzo è sempre una persona. Quello che
nessuna di queste regole vede lo guarda il secondo modello, che ha davanti
l'indirizzo e i nomi degli elementi come uscirebbero e blocca tutto il percorso
se ci riconosce qualcuno. Un nome utente è lo stesso su più siti, e sarebbe
bastato lui a rimettere insieme i tuoi percorsi. Bastava un codice uguale su due percorsi per capire che erano della
